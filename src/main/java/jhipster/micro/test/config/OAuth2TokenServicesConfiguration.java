package jhipster.micro.test.config;
...
import jhipster.micro.test.security.oauth2.CachedUserInfoTokenServices;
import jhipster.micro.test.security.oauth2.SimpleAuthoritiesExtractor;
import jhipster.micro.test.security.oauth2.SimplePrincipalExtractor;
