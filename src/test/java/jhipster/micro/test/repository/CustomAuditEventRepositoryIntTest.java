package jhipster.micro.test.repository;

import jhipster.micro.test.JHipsterMicroServicesApp;
import jhipster.micro.test.config.Constants;
import jhipster.micro.test.config.audit.AuditEventConverter;
import jhipster.micro.test.domain.PersistentAuditEvent;
...
import static jhipster.micro.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
